...
- **operation_types** [*Array\<Number\>*] (optional) - operation types to track you can fint number https://developers.stellar.org/docs/data/analytics/hubble/data-catalog/data-dictionary/bronze/history-operations 
